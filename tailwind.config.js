  ...
  theme: {
    extend: {
      colors: {
        ...
        neutralDarkest: "#101112",
        primaryLight: "#eff6f5", // rgb(239, 246, 245)
        primarySublte: "#cde2e1", // rgb(205, 226, 225)
        primaryMid: "#93bfbf", // rgb(147, 191, 191)
        primaryDefault: "#5ea09f", // rgb(94, 160, 159)
        primaryDark: "#437271", // rgb(67, 114, 113)
        primaryDarker: "#274343", // rgb(39, 67, 67)
